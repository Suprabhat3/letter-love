          ...
          <AnimatePresence mode="wait">
            {!showMessage ? (
              ...
              >
                ...
                <h1 className="font-handwriting text-6xl md:text-7xl text-gradient mb-6 leading-tight py-2">
                  Happy <br /> Birthday!
                </h1>

                <p className="text-xl text-foreground/80 font-serif mb-8 max-w-xs mx-auto leading-relaxed">
