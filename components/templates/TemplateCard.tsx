      ...
      <Link href={`/templates/${template.id}`} className="block h-full">
        ...
        >
          ...
          <div className="relative z-10 h-full p-7 flex flex-col">
            ...
            >
              <span 
                className="w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg transform transition-transform hover:scale-110 active:scale-95 bg-gradient-to-br from-primary to-pink-600"
              >
                <ArrowRight size={22} />
              </span>
            </motion.div>
