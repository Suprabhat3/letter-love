...
export const reasonsTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "center", sizePx: 840, color: "glow", opacity: 0.16, durationSec: 21, delaySec: 6 },
    ],
  },
  decor: [
    {
...
export const proposalTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "center", sizePx: 840, color: "glow", opacity: 0.18, durationSec: 19, delaySec: 5 },
    ],
  },
  decor: [
    {
...
export const longDistanceTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "top-left", sizePx: 640, color: "glow", opacity: 0.22, durationSec: 14, delaySec: 4 },
      { anchor: "bottom-right", sizePx: 580, color: "primary", opacity: 0.12, durationSec: 23, delaySec: 8 },
    ],
  },
  decor: [
    {
...
export const crushTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "top-right", sizePx: 620, color: "glow", opacity: 0.22, durationSec: 13, delaySec: 4 },
      { anchor: "bottom-left", sizePx: 560, color: "primary", opacity: 0.1, durationSec: 21, delaySec: 8 },
    ],
  },
  // Nervous, not shy of the screen: this had five glyphs on a whole page,
  // which read as a rendering bug rather than as restraint.
  decor: [
    {
      kind: "float",
      phase: "always",
...
export const justBecauseTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "bottom-left", sizePx: 580, color: "secondary", opacity: 0.3, durationSec: 15, delaySec: 3 },
