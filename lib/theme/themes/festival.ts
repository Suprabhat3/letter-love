...
export const diwaliTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "center", sizePx: 820, color: "glow", opacity: 0.14, durationSec: 18, delaySec: 5 },
    ],
  },
  decor: [
    {
...
export const rakhiTheme: ThemeDraft = {
  ...
  ambient: {
    enabled: true,
    blobs: [
      { anchor: "top-left", sizePx: 660, color: "secondary", opacity: 0.42, durationSec: 12 },
      { anchor: "bottom-right", sizePx: 580, color: "glow", opacity: 0.26, durationSec: 15, delaySec: 3 },
      { anchor: "center", sizePx: 820, color: "secondary", opacity: 0.16, durationSec: 20, delaySec: 6 },
    ],
  },
  decor: [
    {
...
export const karwaChauthTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "center", sizePx: 840, color: "glow", opacity: 0.12, durationSec: 24, delaySec: 7 },
    ],
  },
  decor: [
    {
...
export const newYearTheme: ThemeDraft = {
  ...
  ambient: {
    ...
    blobs: [
      ...
      { anchor: "center", sizePx: 840, color: "glow", opacity: 0.14, durationSec: 19, delaySec: 5 },
    ],
  },
  decor: [
    {
